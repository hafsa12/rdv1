                ...
                if($rdv){
                    ...
                    if($blobs){
                        ...
                        foreach($blobs as $blob){
                            ...
                            $data[] = $nom.'##'.$url . Atexo_Utils_UrlProtector::protectUrl('?page=administration.FrameDocument&id='.$idRdv.'&idBlob=' . $idBlob.'&nomBlob='.$nom)."#zoom=100";
                            if($i==0){
                                $this->nomFile = $nom;
                                $this->url = $url . Atexo_Utils_UrlProtector::protectUrl('?page=administration.FrameDocument&id='.$idRdv.'&idBlob=' . $idBlob.'&nomBlob='.$nom);
                                $i++;
                            }
                        }
