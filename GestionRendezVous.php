...
if($etab==109 && $prestation->getIdPrestation===1636) $path = "ressources/word/recap_rdv_52_ar"  . ".docx";
 else       $path = "ressources/word/recap_rdv_". $idOrg . "_" . $lang . ".docx";
        $vendorpath = 'protected/library/vendors/vendor';
        require_once $vendorpath.'/autoload.php';
        if(!file_exists($path)){
				if($etab==109 && $prestation->getIdPrestation===1636) $path = "ressources/word/recap_rdv_52" . $lang . ".docx";
